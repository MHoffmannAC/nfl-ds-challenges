...
ABtest_files = [f for f in os.listdir(ABtest_FILES_SUBDIRECTORY) if f.endswith('.ipynb')]
...
if not processed_file_options:
    st.warning(f"No files found in the '{ABtest_FILES_SUBDIRECTORY}' directory. Please ensure files are present.")
else:
